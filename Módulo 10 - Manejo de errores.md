...
FileNotFoundError: [Errno 2] No such file or directory: '/path/to/mars.jpg'
```
![Traceback desde terminal](images/Traceback-terminal.PNG)
...
```
![Try y Except](images/Try-Except.PNG)
...
```
![Excepción de directorio](images/Error-directory.PNG)
...
Couldn't find the config.txt file!
```
![Excepción de permisos](images/Error.PNG)
...
![Múltiples excepciones](images/Permission-Error.PNG)
...
```
![Alias excepción](images/Error-As.PNG)
...
Couldn't find the config.txt file!
```
![Excepciones genéricas](images/OSError.PNG)
...
```
![Excepción creada](images/def-exception.PNG)
...
```
![Error de tipado](images/TypeError.PNG)
...
```
![Error de argumentos](images/TypeError-argument.PNG)
